...
require(ncdf4, lib.loc=paste0('/afs/crc.nd.edu/user/',first,'/',user,'/Rlibs'))
require(ggplot2, lib.loc=paste0('/afs/crc.nd.edu/user/',first,'/',user,'/Rlibs'))
require(lubridate, lib.loc=paste0('/afs/crc.nd.edu/user/',first,'/',user,'/Rlibs'))
require(utils, lib.loc=paste0('/afs/crc.nd.edu/user/',first,'/',user,'/Rlibs'))
require(tibble, lib.loc=paste0('/afs/crc.nd.edu/user/',first,'/',user,'/Rlibs'))
require(glue, lib.loc=paste0('/afs/crc.nd.edu/user/',first,'/',user,'/Rlibs'))
require(udunits2, lib.loc=paste0('/afs/crc.nd.edu/user/',first,'/',user,'/Rlibs'))
