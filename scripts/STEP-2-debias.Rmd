...
Description: This step combines the third and fourth steps of Christy's met workflow, which correct for bias through the generation of daily ensembles using the three different met data sources, reject ensemble members with unlikely values, and generate visual checks of the data. 
...
# Step 0: Adjust variables for site 
