...
Description: This step contains a modified version of the seventh step of Christy's met workflow, which rejects and removes ensemble members containing impossible values and generates figures to visually check the quality of the predictions. 
...
# Step 0: Set site details for step 
...
n.hr <- 5 # How many independent hourly ensembles we want to show
