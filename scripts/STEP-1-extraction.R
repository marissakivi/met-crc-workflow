...
####################
# Step 2: Extract NLDAS data
####################

source(file.path(path.pecan, "extract_local_NLDAS.R"))
ldas.type = "NLDAS"
## MSK: need to get file path for the data from the external drive 
#path.nldas = paste0(path.data,'/')
